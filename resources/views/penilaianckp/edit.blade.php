...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col p-0">
            <h4>Entri Penilaian CKP</h4>
        </div>
        <div class="col p-0">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">Dashboard</a>
                </li>
                <li class="breadcrumb-item active">Entri Penilaian CKP</li>
            </ol>
        </div>
    </div>
    <!-- row -->
    ...
    <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
									@foreach ($ckp as $ckp)	
                                        <form action="{{ url('/editnilai/'.$ckp->bulan_prov.'/'.$ckp->tahun_prov.'/'.$ckp->id_ckp_prov) }}" method="POST">
										@csrf
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="realisasi_ckp_prov" name="realisasi_ckp_prov" value="{{ $ckp->realisasi_ckp_prov }}" disabled required />
                                            </div>
                                            <div class="mb-3">
                                                <label for="nilai_ckp_prov" class="form-label" style="color:red">Kualitas (Diisi oleh Ketua Tim/Penilai)</label>
                                                <input type="number" class="form-control" id="nilai_ckp_prov" placeholder="100" min="0" max="100" name="nilai_ckp_prov" value="{{ $ckp->nilai_ckp_prov }}" required />
                                            </div>
                                            <div class="mb-3">
                                                <label for="butir_ak" class="form-label">Butir Kegiatan</label>
                                                <input type="text" class="form-control" id="butir_ak" name="butir_ak" value="{{ $ckp->butir_ak }}" disabled />
                                            </div>
                                            <div class="mb-3">
                                                <label for="jum_ak" class="form-label">Capaian Angka Kredit</label>
                                                <input type="text" class="form-control" id="jum_ak" name="jum_ak" value="{{ $ckp->jum_ak }}" disabled />
                                            </div>
                                            <div class="mb-3">
